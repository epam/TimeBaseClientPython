...
class HTMLTestRunner(Template_mixin):
    ...
    def run(self, test):
        ...
        print('Time Elapsed: {}'.format((self.stopTime-self.startTime)))
        return result
    ...
    def _generate_report_test(self, rows, cid, tid, n, t, o, e):
        ...
        if isinstance(o,str):
            ...
            if py3:
                uo = bytes(o, 'utf-8').decode('ascii', errors='ignore')
            else:
                uo = o.decode('ascii', errors='ignore')
        else:
            uo = o
        if isinstance(e,str):
            # TODO: some problem with 'string_escape': it escape \n and mess up formating
            ...
            if py3:
                ue = bytes(e, 'utf-8').decode('ascii', errors='ignore')
            else:
                ue = e.decode('ascii', errors='ignore')
        else:
            ue = e
